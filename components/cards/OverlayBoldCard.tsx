...
export function OverlayBoldCard({
  ...
  return (
    <div ref={cardRef} style={{ width: "100%", padding: "52px 24px 48px", boxSizing: "border-box", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center" }}>
      ...
      <div style={{ width: 48, height: 2, background: "rgba(255,255,255,0.35)", borderRadius: 2, margin: "16px auto", boxShadow: "0 1px 4px rgba(0,0,0,0.4)" }} />
      <p style={{ fontFamily: "system-ui, sans-serif", fontSize: 12, fontWeight: 600, color: "rgba(255,255,255,0.8)", letterSpacing: "0.12em", textTransform: "uppercase", textShadow: SHADOW_SM }}>{typeLabel}</p>
